...
<head>
    ...
    <title>Buat Laporan — JalanKita</title>
...
<body class="font-sans antialiased bg-[#0b0e14] text-white min-h-screen">
    <header class="border-b border-slate-800">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
            ...
            <nav class="flex items-center gap-3 text-sm">
                <a href="{{ route('laporan.index') }}" class="px-4 py-2 rounded-lg border border-slate-700 text-slate-200 hover:border-slate-500">Riwayat Laporan</a>
    ...
    <main class="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <h1 class="text-2xl sm:text-3xl font-extrabold mb-6">Buat Laporan</h1>

        <div class="bg-[#131722] border border-slate-800 rounded-xl p-8 text-slate-400">
            Halo, {{ auth()->user()->name }}. Formulir laporan (lokasi, kategori kerusakan, foto bukti)
            akan ditampilkan di sini setelah tabel &amp; migration laporan dibuat.
        </div>
    </main>
</body>
</html>